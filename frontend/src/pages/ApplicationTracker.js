...
const s = {
  ...
  empty: { textAlign: 'center', padding: '60px 24px', background: 'rgba(26,26,29,0.6)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', borderRadius: 20, border: '1px solid rgba(255,255,255,0.08)' },
  ...
  selBtn: { padding: '10px 16px', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 10, background: 'rgba(26,26,29,0.6)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left', transition: 'all 0.2s' },
  ...
  pipeline: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '28px 20px', background: 'rgba(26,26,29,0.6)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', marginBottom: 16, overflow: 'auto' },
  ...
  card: { background: 'rgba(26,26,29,0.6)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 24, marginBottom: 16 },
